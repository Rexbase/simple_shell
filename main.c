...
int parse_command(char *line) {
    ...
    // Remove the comment (if any) by ignoring everything after '#'
    ...
    // Split the line into separate commands based on && and ||
    ...
    while (token != NULL) {
        ...
        // Move to the next command separated by && or ||
...
// Add other functions related to aliases and environment variables here
...
int main(int argc, char *argv[]) {
    if (argc == 2) {
        ...
        // Interactive mode with a prompt and reading from stdin
        char line[MAX_COMMAND_LENGTH];
